...
### Регіон та URL
- **Регіон:** `europe-west1` (Бельгія).
- **URL:** `https://slovko-alik532-default-rtdb.europe-west1.firebasedatabase.app`
- **Використання:** Використовується для Presence (онлайн-статус) та миттєвих сигналів ("помахати").

### Правила (Security Rules)
- Встановлено згідно з файлом `database.rules.json`.
- Дозволяють публічне читання статусів та приватне читання/запис сигналів.
