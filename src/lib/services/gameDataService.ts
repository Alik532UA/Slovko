import { loadLevel, loadTopic, loadTranslations, loadTranscriptions, loadPhrasesLevel } from '../data/wordService';
...
export class GameDataService {
     ...
     */
    async loadGameData(settings: AppSettings, playlists: PlaylistData): Promise<GameData> {
        const { sourceLanguage, targetLanguage, mode, currentLevel, currentTopic, currentPlaylist } = settings;
        ...
        try {
            ...
            if (mode === 'playlists' && currentPlaylist) {
                ...
                const playlistPairs = currentPlaylist === 'mistakes'
                    ...
                    : (currentPlaylist === 'favorites' ? playlists.favorites : playlists.extra);
