...
<style>
	...
	.ctrl-btn {
		...
		height: 24px;
		/*
		 * WCAG 2.2 SC 2.5.8: ціль не менша за 24x24 CSS-пікселі.
		 *
		 * `width: 24px` цього НЕ гарантував: кнопка стоїть у flex-рядку, а
		 * `flex-shrink` типово дорівнює 1, тож у вузькій картці ширина
		 * стискалася до 18px. Оголошене й фактичне розходилися мовчки — axe
		 * міряв 18x24 там, де в стилях стоїть 24x24.
		 */
		flex-shrink: 0;
		border-radius: 8px;
		transition: all 0.2s;
