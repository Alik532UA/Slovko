<script lang="ts">
	...
	let langName = $derived($_(`language.${speechModalStore.lang}`) || speechModalStore.lang.toUpperCase());
</script>
	...
	>
		<div class="content">
			...
			<div class="description">
				...
				<p>
					{@html $_("errors.speech.modalDesc2", { values: { lang: `<strong>${langName}</strong>` }, default: `На жаль, ваш поточний браузер або операційна система не підтримують синтез мовлення для <strong>${langName}</strong> мови.` })}
				</p>
				<p>
