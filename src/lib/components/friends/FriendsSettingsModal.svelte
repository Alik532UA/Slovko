...
>
    ...
    >
        <div class="modal-header">
            ...
            <p class="subtitle">{$_("settings.privacySubtitle", { default: "Manage who can see you and interact with you" })}</p>
        </div>
                ...
                <div class="settings-list">
                    <div class="setting-item">
                        <div class="setting-info">
                            <span class="setting-label">{$_("settings.showInSearch", { default: "Show me in search" })}</span>
                            <span class="setting-desc">{$_("settings.showInSearchDesc", { default: "Allow other users to find you by email or name" })}</span>
                        </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-info">
                            <span class="setting-label">{$_("settings.allowFriendRequests", { default: "Allow friend requests" })}</span>
                            <span class="setting-desc">{$_("settings.allowFriendRequestsDesc", { default: "Allow others to send you friend requests" })}</span>
                        </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-info">
                            <span class="setting-label">{$_("settings.shareStats", { default: "Share statistics" })}</span>
                            <span class="setting-desc">{$_("settings.shareStatsDesc", { default: "Allow friends to see your learning progress" })}</span>
                        </div>
        ...
        <div class="modal-footer">
            <button class="save-btn" onclick={handleSave} disabled={isSaving || isLoading}>
                {#if isSaving}
