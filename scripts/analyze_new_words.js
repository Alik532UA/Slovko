...
for (const line of lines) {
    ...
    if (existingData.has(enLower)) {
        ...
        for (const cand of candidates) {
            ...
            if (candUk === newUk || candUk.includes(newUk) || newUk.includes(candUk)) {
                exists = true;
                break;
            }
    ...
    if (!exists) {
        ...
        if (sectionLower.includes('verb') || sectionLower.includes('дієслова')) suffix = '_verb';
        else if (sectionLower.includes('adjective') || sectionLower.includes('прикметники')) suffix = '_adj';
        else if (sectionLower.includes('noun') || sectionLower.includes('іменники')) suffix = '_noun'; // Though usually nouns are default
