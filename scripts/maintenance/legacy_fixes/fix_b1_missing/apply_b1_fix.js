...
const missingB1 = {
	...
	encourage_growth: {
		...
		de: "ermutigen",
		nl: "aanmoedigen",
		crh: "cesaretlendirmek",
		transcription: "ɪnˈkʌrɪdʒ",
	},
	establish_base: {
		uk: "встановлювати (базу)",
		en: "establish",
		de: "etablieren",
		nl: "vestigen",
		crh: "qurmaq",
	...
	sightseeing: {
		...
		en: "sightseeing",
		de: "Besichtigung",
		nl: "bezienswaardigheden bekijken",
		crh: "seyaat",
	...
	appearance: {
		uk: "зовнішність / поява",
		en: "appearance",
		de: "Aussehen / Erscheinung",
		nl: "uiterlijk",
		crh: "körünüş",
	...
	conclusion_end: {
		...
		nl: "conclusie",
		crh: "netic",
		transcription: "kənˈkluːʒ(ə)n",
	},
	confidence_trust: {
		uk: "довіра / впевненість",
		en: "confidence",
		de: "Vertrauen",
		nl: "vertrouwen",
		crh: "inam",
		transcription: "ˈkɒnfɪd(ə)ns",
	},
	danger_risk: {
		uk: "небезпека",
		en: "danger",
	...
	look_for: {
		...
		nl: "zoeken",
		crh: "qıdırmaq",
		transcription: "lʊk fɔː",
	},
	look_forward_to: {
		uk: "чекати з нетерпінням",
		en: "look forward to",
		de: "sich freuen auf",
		nl: "uitkijken naar",
		crh: "sabırsızlıqnen bekleme",
		transcription: "lʊk ˈfɔːwəd tuː",
	},
	turn_down_volume: {
		uk: "зменшити гучність",
		en: "turn down",
		de: "leiser machen",
		nl: "zachter zetten",
		crh: "yavaşlatmaq",
	...
	grow_up: {
		uk: "рости / дорослішати",
		en: "grow up",
		de: "aufwachsen",
		nl: "opgroeien",
		crh: "büyümek",
		transcription: "ɡrəʊ ʌp",
	},
	pick_up_object: {
		uk: "піднімати / підбирати",
		en: "pick up",
		de: "aufheben",
		nl: "oppakken",
		crh: "kötürmek",
